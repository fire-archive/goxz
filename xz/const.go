...
// of each chunk.
//
// Furthermore, if a SeekReader object is created, a single cache with a size
// equivalent to this buffer will be allocated to help absorb short seek-read
// operations that are typical of access patterns. In order to make cache logic
// much simpler, the buffer size will be rounded to the closest power of two.
const (
